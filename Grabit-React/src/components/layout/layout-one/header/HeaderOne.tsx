            ...
            <div className="col header-top-right d-none d-lg-block">
              <div className="header-top-right-inner d-flex justify-content-end">
                ...
                <Dropdown className="header-top-lan-curr header-top-lan">
                  <Dropdown.Toggle variant="" className="dropdown-toggle" id="dropdown-language">
                    {locale === "ar" ? "العربية" : "English"} 
                    <i className="fi-rr-angle-small-down" aria-hidden="true"></i>
                  </Dropdown.Toggle>

                  <Dropdown.Menu as="ul">
                    <Dropdown.Item as="li" onClick={() => changeLanguage("en")}>English</Dropdown.Item>
                    <Dropdown.Item as="li" onClick={() => changeLanguage("ar")}>العربية</Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
